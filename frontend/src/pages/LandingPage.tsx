...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#030308] text-slate-100 selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-white/[0.08] bg-[#030308]/90 py-12 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-8 px-6 md:flex-row">
          
          {/* Brand & System Architect Badge */}
          <div className="flex flex-col items-center gap-3 md:items-start">
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-cyan-500 to-violet-500 shadow-[0_0_15px_rgba(34,211,238,0.4)]">
            ...
            <p className="font-mono text-[11px] uppercase tracking-widest text-slate-500">
              © {new Date().getFullYear()} Autonomous Career Orchestration
            </p>
          </div>

          {/* Developer / Professional Profile Card */}
          <div className="flex flex-col items-center gap-4 sm:flex-row">
            <div className="flex items-center gap-2.5 rounded-2xl border border-white/[0.06] bg-white/[0.02] px-4 py-2.5 backdrop-blur-xl">
              <div className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-emerald-500" />
              </div>
              <span className="font-mono text-xs text-slate-400">
                Engineered by <strong className="font-display font-bold tracking-wide text-white">Ayman Saeid</strong>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              <motion.a
                ...
                className="group flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3.5 py-2 text-xs font-semibold text-slate-300 transition-all hover:border-cyan-500/40 hover:bg-cyan-500/10 hover:text-cyan-300 hover:shadow-[0_0_20px_rgba(34,211,238,0.2)]"
              >
                <GithubIcon size={15} className="transition-transform group-hover:scale-110" />
              ...
              <motion.a
                ...
                className="group flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3.5 py-2 text-xs font-semibold text-slate-300 transition-all hover:border-violet-500/40 hover:bg-violet-500/10 hover:text-violet-300 hover:shadow-[0_0_20px_rgba(139,92,246,0.2)]"
              >
                <LinkedinIcon size={15} className="transition-transform group-hover:scale-110" />
