    ...
    <div className="space-y-10">
      ...
      <AnimatePresence>
        {error && (
          ...
          >
            <div className="bg-red-500/10 border border-red-500/25 text-red-400 p-4 rounded-2xl mb-6 text-sm font-bold flex items-center gap-2.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] xl:grid-cols-[350px_1fr] gap-6 items-start">
        ...
        <section className="space-y-6">
          ...
          <div className="glass rounded-2xl min-h-[400px] p-2 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/[0.06] blur-[100px] pointer-events-none rounded-full" />
